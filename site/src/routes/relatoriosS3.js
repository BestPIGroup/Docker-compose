...
router.post([
    ...
    "/solicitar-relatorio-geral",
    "/solicitar_relatorio_geral",
    "/download-geral",
    "/baixar_relatorio_geral"
], relatoriosS3Controller.gerarRelatorioGeral);
router.post([
    "/gerar-relatorio-servidor",
    "/gerar_relatorio_servidor",
    "/solicitar-relatorio-servidor",
    "/solicitar_relatorio_servidor",
    "/download-servidor",
    "/baixar_relatorio_servidor"
], relatoriosS3Controller.gerarRelatorioServidor);
